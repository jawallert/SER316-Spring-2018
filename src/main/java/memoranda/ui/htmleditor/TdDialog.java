...
public class TdDialog extends JDialog {
  ...
  void jbInit() throws Exception {
    ...
    header.setIcon(new ImageIcon(main.java.memoranda.ui.htmleditor.ImageDialog.class.getResource("/main/resources/htmleditor/icons/tablebig.png")));
    ...
    tdBgcolorB.setIcon(new ImageIcon(main.java.memoranda.ui.htmleditor.ImageDialog.class.getResource("/main/resources/htmleditor/icons/color.png")));
    ...
    trBgcolorB.setIcon(new ImageIcon(main.java.memoranda.ui.htmleditor.ImageDialog.class.getResource("/main/resources/htmleditor/icons/color.png")));
    ...
    bgColorB.setIcon(new ImageIcon(main.java.memoranda.ui.htmleditor.ImageDialog.class.getResource("/main/resources/htmleditor/icons/color.png")));
