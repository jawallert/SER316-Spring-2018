...
public class WorkPanel extends JPanel {
	...
	void jbInit() throws Exception {
		...
		agendaB.setIcon(
			new ImageIcon(
				main.java.memoranda.ui.AppFrame.class.getResource(
					"/main/resources/ui/icons/agenda.png")));
		...
		eventsB.setIcon(
			new ImageIcon(
				main.java.memoranda.ui.AppFrame.class.getResource(
					"/main/resources/ui/icons/events.png")));
		...
		tasksB.setIcon(
			new ImageIcon(
				main.java.memoranda.ui.AppFrame.class.getResource(
					"/main/resources/ui/icons/tasks.png")));
		...
		notesB.setIcon(
			new ImageIcon(
				main.java.memoranda.ui.AppFrame.class.getResource(
					"/main/resources/ui/icons/notes.png")));
		...
		filesB.setIcon(
			new ImageIcon(
				main.java.memoranda.ui.AppFrame.class.getResource(
					"/main/resources/ui/icons/files.png")));
