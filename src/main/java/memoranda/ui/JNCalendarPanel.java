...
public class JNCalendarPanel extends JPanel {
  ...
  public Action dayBackAction =
        new AbstractAction(
            "Go one day back",
            new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/main/resources/ui/icons/back16.png"))) {
  ...
  public Action dayForwardAction =
        new AbstractAction(
            "Go one day forward",
            new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/main/resources/ui/icons/forward16.png"))) {
        public void actionPerformed(ActionEvent e) {
  ...
  public Action todayAction =
        new AbstractAction(
            "Go to today",
            new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/main/resources/ui/icons/today16.png"))) {
        public void actionPerformed(ActionEvent e) {
  ...
  void jbInit() throws Exception {
    ...
    dayForwardB.setIcon(new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/main/resources/ui/icons/forward.png")));
    dayForwardB.setText("");
    ...
    todayB.setIcon(new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/main/resources/ui/icons/today.png")));
    todayB.setText("");
    ...
    dayBackB.setIcon(new ImageIcon(main.java.memoranda.ui.AppFrame.class.getResource("/main/resources/ui/icons/back.png")));
    dayBackB.setText("");
